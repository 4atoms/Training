class flightNameslist{
    constructor(){
    this.element=document.getElementById("data");
    this.flights=document.getElementById("flights");
    this.elementRemo=document.getElementById("clickId");
    }    
     displayFlights = () => {
        flights.removeChild(this.elementRemo)
        var xmlHttp = new XMLHttpRequest();
        xmlHttp.open("GET","https://run.mocky.io/v3/782a2a9c-cbbc-4995-b304-a41303a58121");
     ...
     checkAvailability = (url) => {
        ...
        closebutton.onclick = function() {flight.closePopup()}
     ...
     closePopup =() => {
        ...
        if(pop != null){
            ...
            this.element.removeChild(pop)
        }
    }
}
const flight=new flightNameslist();